...
const ConfirmDialog = () => {
  ...
  return (
    ...
    >
      ...
      <Icon name="wallet" type="material-community" color="black" size={sizeFactor * 3} style={{ marginBottom: sizeFactor }} />
      <String
        style={{
      ...
      <Text style={{ marginBottom: sizeFactor * 1.5, textAlign: "center", alignSelf: "center", fontSize: sizeFactor }}>Đây là một custom alert bao gồm 1 icon và 2 nút. T sẽ tạo 1 component riêng và thêm loại dialog 3 nút nếu cần nhưng giờ buồn ngủ quá push cái ngủ đây.</Text>
      <Divider />
