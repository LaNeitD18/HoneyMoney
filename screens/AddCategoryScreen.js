        ...
        return (
            <ScreenView>
                ...
                <RoundedView>
                    ...
                    <TextInput style={styles.inputText} placeholder="Danh mục của tôi" onChangeText={(text) => this.props.changeName(text)} />
                    <Divider />
                    <String style={{ fontWeight: "bold" }}>Loại chi tiêu</String>
                    <AddWalletKindSelect buttons={["Vay/Trả", "Chi tiêu", "Thu nhập"]} selectedIndex={this.props.selectedType} onPress={(index) => this.props.changeType(index)} />
                    <Divider />
                            ...
                            <TouchableOpacity>
                                <ListItem
                                    ...
                                    chevron={
                                        ...
                                        item.title == "Thêm mới" ? false : { size: sizeFactor * 1.5 }
                                    }
                ...
                <Divider />
                <Button color="white" background={colors.blue} style={{ marginHorizontal: sizeFactor }} onPress={this.createCategory}>
                    Lưu thay đổi
                </Button>
            </ScreenView>
        );
