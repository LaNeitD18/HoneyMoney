    ...
    renderCategoryHorizon = () => {
        ...
        for (let index = 0; index <= categories.length; index++) {
            if (index < categories.length) {
                ...
                row.push(
                    <Category choosed={this.state.selectedCategory == categories[index].key ? true : false} key={categories[index].key} source={iconPath} onPress={() => this.chooseCategory(categories[index])}>
                        {name}
                    </Category>
                );
    ...
    render() {
        ...
        return (
            <ScreenView style={{ backgroundColor: this.state.defaultColor }}>
                ...
                >
                    <String style={{ color: "white", fontWeight: "bold", marginBottom: 0 }}>Số tiền</String>
                    <TextInput
                ...
                >
                    ...
                    <TouchableOpacity>
                        <View style={{ justifyContent: "center" }}>
                            <Icon name="chevron-down" type="material-community" color="black" size={sizeFactor * 2} />
                        </View>
                    </TouchableOpacity>
                </View>
                <View
                ...
                >
                    ...
                    <TextInput returnKeyType="done" style={styles.inputMultilineText} multiline={true} placeholder="50k cho một ly trà sữa?" />
                </View>
